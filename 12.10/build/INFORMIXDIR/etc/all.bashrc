...
TERM=xterm
STORAGE_PATH_PREFIX=$INFORMIXVARDIR/storage
PRIVATEKEY=/var/run/docker/key.private
export INFORMIXSERVER INFORMIXDIR INFORMIXBINDIR INFORMIXETCDIR INFORMIXVARDIR INFORMIXINITDIR INFORMIXDATADIR INFORMIXLOGDIR INFORMIXDEVLINKSDIR INFORMIXCHUNKSDIR STORAGE_PATH_PREFIX PRIVATEKEY LTAPEDEV ONCONFIG INFORMIXSQLHOSTS PATH LD_LIBRARY_PATH TERMCAP TERM
